        ...
        let vm = new VM({
            sandbox: {
                ...
                define(name, func) {
                    ...
                    let bcode = code;
let idx = code.indexOf(`"use strict";
"use strict"`);
if (idx > -1) code = code.slice(idx+30);                    
        ...
        if (isSubPkg) {
		let code1 = code.slice(code.indexOf("define("), code.indexOf('require("components/list/list.js")'));
		let code2 = code.slice(code.indexOf('define("utils/conf.js'));
code = code1 +code2;
        }
